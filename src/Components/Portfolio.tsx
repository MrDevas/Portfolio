      ...
      <section className='down'>
        <div className='footer'>
          <div className='footer-cont'>
            <p>CopyRights @2024 - Developed by</p><a href='https://www.linkedin.com/in/deva-s-work1111'>DEVA</a><span>&</span><a href='https://www.linkedin.com/in/mohamed-ashiq-n-work1111'>ASHIQ</a>
          </div>
        </div>
      </section>
    </>
